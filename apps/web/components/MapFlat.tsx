...
/**
 * El mapa plano: **territorio, no grafo**.
 *
 * Es el **respaldo** del mundo en relieve ([ADR-042](../../../docs/DECISIONS.md#adr-042)):
 * lo que se ve sin WebGL o con `prefers-reduced-motion`. No es un hueco gris — es la vista
 * completa, con las mismas provincias y las mismas órdenes.
 *
