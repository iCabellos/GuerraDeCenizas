...
describe('previewAttack — previsualización desde la vista del jugador', () => {
  const view = (overrides: Partial<PlayerView>): PlayerView => ({
    ...
    map: {
      regions: [
        { id: 0, kind: 'plain', sector: 0, ring: 0, slot: 0, zone: 1, x: 0, y: 0 },
        { id: 1, kind: 'plain', sector: 0, ring: 0, slot: 1, zone: 1, x: 10, y: 0 },
        { id: 2, kind: 'plain', sector: 0, ring: 0, slot: 2, zone: 1, x: 20, y: 0 },
      ],
    ...
    self: {
      ...
      anomalies: [],
      resources: { supply: 10, industry: 10, intel: 5, ash: 1, ore: 0, ember: 0 },
      tiers: { line: 1, fire: 1, sky: 1 },
      policies: {
        deepVeins: 0, caravans: 0, recasting: 0, cadence: 0, escalade: 0, marchDoctrine: 0,
      },
    },
    opponents: [],
    events: [],
